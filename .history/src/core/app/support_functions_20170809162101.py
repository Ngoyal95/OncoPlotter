...
def import_plot_data(file_path):
    ...
    #Waterfall
    #standard columns (always present & in this order) are: 'Patient number', 'Best response percent change', 'Patient response', 'Cancer' (always first 4 cols, in this order)
