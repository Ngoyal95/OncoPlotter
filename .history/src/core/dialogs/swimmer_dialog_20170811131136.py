...
class SwimmerPlotter(QWidget):
    ...
    def default_plot(self):
        ...
        self.stack_lists = [x for x in self.swimmer_data.ix[:,1:6]] #col 6 is the total time on treatment sum, don't include
        print(self.stack_lists)
        self.offset_list = [0]*len(self.stack_lists[0])
