    ...
    def __init__(self,parent,bar_keys_colors):
        ...
        def populate(self):
            ...
            for key in self.keys:
                self.color_box = QtGui.QPixmap(20,20)
                self.color_box.fill(QtGui.QColor('red'))
                self.addItem(self.color_box,key)
...
class Waterfall(QWidget, waterfall.Ui_Waterfall):
    ...
    def add_items(self):
        ...
        for rect in self.rectangles_received:
            ...
            self.tree.setItemWidget(self.rect_item, 4, CustomCombo(self.))
