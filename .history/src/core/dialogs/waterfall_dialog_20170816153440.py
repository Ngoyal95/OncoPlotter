...
class Waterfall(QWidget, waterfall.Ui_Waterfall):
    ...
    def add_items(self):
        ...
        for rect in self.rectangles_received:
            ...
            self.tree.setItemWidget(self.rect_item, 4, CustomCombo(self,self.keys_and_colors,self.keys_)) #send the label of the rectangle as the key to determine color
