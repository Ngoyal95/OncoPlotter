...
class CustomCombo(QComboBox):
    ...
    def populate(self):
        ...
        self.setCurrentIndex(self.findText(self.response_type,flags=QtCore.Qt.MatchContains).currentText()) #default to the patient cancer type
...
class Waterfall(QWidget, waterfall.Ui_Waterfall):
    ...
    def get_updated_color_coding(self):
        ...
        for i in range(child_count):
            ...
            print(self.tree.itemWidget(child_item,4))
        pass
