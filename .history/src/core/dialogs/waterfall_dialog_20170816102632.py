...
class CustomCombo(QComboBox):
    def __init__(self,parent,bar_keys_colors,cancer_type):
    ...
    def populate(self):
        ...
        #self.setCurrentIndex(self.findText(self.cancer_type)) #default to the patient cancer type
        print(self.findText(self.cancer_type,flags=QtCore.Qt.MatchContains))
...
class Waterfall(QWidget, waterfall.Ui_Waterfall):
    ...
    def add_items(self):
        ...
        for rect in self.rectangles_received:
            ...
            self.tree.setItemWidget(self.rect_item, 4, CustomCombo(self,self.keys_and_colors,self.waterfall_data['Cancer'][i]))
