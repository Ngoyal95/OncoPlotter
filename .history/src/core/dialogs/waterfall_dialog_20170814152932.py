...
from PyQt5.QtWidgets import (QApplication, QDialog, QWidget, QPushButton, QVBoxLayout, QTreeWidget, QTreeWidgetItem, QComboBox)
...
class Waterfall(QWidget, waterfall.Ui_Waterfall):
    ...
    def add_items(self):
        ...
        for rect in self.rectangles_received:
            ...
            i+=1
        self.tree.header().setSectionResizeMode(QtGui.QHeaderView.ResizeToContents)
