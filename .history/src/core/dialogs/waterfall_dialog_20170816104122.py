...
class Waterfall(QWidget, waterfall.Ui_Waterfall):
    ...
    def get_settings(self):
        try:
            ...
            self.keys_and_colors = {
                                    ...
                                    'PD':'#FF6F69',
                                    'SD':'#707070'}
            with shelve.open('WaterfallSettings') as shelf
    ...
    def send_settings(self):
        ...
        self.plot_settings_signal.emit([self.list_general_settings,self.keys_and_colors])
...
class WaterfallPlotter(QWidget):
    ...
    def on_general_settings_signal(self,signal):
        ...
        print(signal)
        self.gen_settings = signal[0]
        self.keys_and_colors =signal[1]
        try:
            hasattr(self,'ax')
